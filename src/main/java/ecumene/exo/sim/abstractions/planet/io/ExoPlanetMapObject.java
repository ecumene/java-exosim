...
public class ExoPlanetMapObject extends XMLObject {
    ...
    public ExoPlanetMapObject(ExoPlanetMapObject parent, Element element){
    ...
    public ExoPlanetMoon toMoon() {
        return new ExoPlanetMoon(getName(), getMass(), getPosition(), getVelocity());
    }
