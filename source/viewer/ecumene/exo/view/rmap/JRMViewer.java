...
public class JRMViewer extends JPanel {
	...
	protected List<RMVPointRenderer> rendererList; // Protected so only subclass members can access it. Makes sense, right?
	...
	protected void paintComponent(Graphics g) {
		...
		} else g.drawString("PMAP context is empty!", 0, 0);
	}
